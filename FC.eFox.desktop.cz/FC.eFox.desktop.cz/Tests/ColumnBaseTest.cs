...
namespace FC.eFox.desktop.cz.Tests
{
    ...
    public class ColumnBaseTest
    {
        ...
        private void LogOut()
        {
            WebdriverExtensions.WaitForElement(driver, basePageControls.btnLogout);
        ...
        /// <summary>
        /// Method to click threw menu tree view
        /// </summary>
        public void GoThrewMenu()
        {
            basePageControls.ProcessItem.Click();
            basePageControls.CC2Item.Click();
            //basePageControls.PreKitItem.Click();
            basePageControls.AssemblyItem.Click();
        }
        public void GetSNAndFillIt()
        {

            System.Threading.Thread.Sleep(2500);
            string Sn = DBSelector.SelectSnByTreenodeId("34");
            basePageControls.TextBox.SendKeys(Sn);
            //basePageControls.TextBox.SendKeys(selector.getSSNByActionId(34));
            basePageControls.TextBox.Submit();
            System.Threading.Thread.Sleep(5000);
            basePageControls.TextBox.SendKeys("14");
            basePageControls.TextBox.Submit();
            System.Threading.Thread.Sleep(2500);
            basePageControls.TextBox.SendKeys("122");
            basePageControls.TextBox.Submit();
        ...
        public void GoThrewMenuToLeakTest()
        {
            basePageControls.ProcessItem.Click();
            basePageControls.CC2Item.Click();
            //basePageControls.PreKitItem.Click();
        ...
        public void GetSNAndFillItLeakTest()
        {

            System.Threading.Thread.Sleep(2500);
            string Sn = DBSelector.SelectSnByTreenodeId("49");
            basePageControls.TextBox.SendKeys(Sn);
            //basePageControls.TextBox.SendKeys(selector.getSSNByActionId(34));
            basePageControls.TextBox.Submit();
        ...
        public void LeakTest()
        {
            try
            {
                GoThrewMenuToLeakTest();
                GetSNAndFillItLeakTest();
            }
            catch (Exception)
            {
